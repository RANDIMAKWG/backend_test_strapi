...
export interface ElementsForm extends Schema.Component {
  ...
  attributes: {
    heading: Attribute.String;
    description: Attribute.Text;
    input: Attribute.Component<'elements.inpiut', true>;
    button: Attribute.Component<'elements.button-link'>;
  };
}

export interface ElementsInpiut extends Schema.Component {
  collectionName: 'components_elements_inpiuts';
  info: {
    displayName: 'Input';
    description: '';
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      ...
      'elements.inpiut': ElementsInpiut;
